    ...
    public partial class Login_Form : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if ((string.IsNullOrEmpty(this.textBox1.Text.Trim())) || (string.IsNullOrEmpty(this.textBox2.Text.Trim())))
            {
                ...
                MessageBox.Show("ユーザー名とパスワードを入力してください", "ログイン : データ入力エラー", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            if (AC.rd.HasRows)
            {
                while (AC.rd.Read())
                {
                    ...
                    MessageBox.Show("ようこそ " + AC.currentFullName, "ログイン : ログイン成功", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            ...
            {
                MessageBox.Show("ユーザー名かパスワードが違います。もう一度やり直してください。", "ログイン : ログイン失敗", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
